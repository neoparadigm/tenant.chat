...
class Assessor:
    ...
    def _get_collection(
        ...
        mapping = {
            ...
            "/identity/conditionalAccess/namedLocations": state.ca_policies,
            "/users":                                     state.users,
            "/guests":                                    state.guests,
            "/admins":                                    state.admins,
            "/reports/authenticationMethods":             state.mfa_registration,
            "/deviceManagement/managedDevices":           state.managed_devices,
            "/deviceManagement/deviceCompliancePolicies": state.compliance_policies,
            "/deviceManagement/deviceCompliance":         state.compliance_policies,
            "/deviceManagement/deviceConfigurations":     state.config_profiles,
            "/deviceManagement/roleScopeTags":            state.config_profiles,
            "/deviceManagement/accessPolicies":           state.config_profiles,
            "/deviceManagement/auditEvents":              state.alerts,
            "/security/secureScores":                     [state.secure_score],
            "/security/alerts_v2":                        state.alerts,
            "/security/auditLog/queries":                 state.alerts,
            "/domains":                                   state.domains,
            "/directoryRoles":                            state.roles,
            "/servicePrincipals":                         state.service_principals,
            "/policies/authenticationMethodsPolicy":      state.users,
            "/teamwork":                                  state.ca_policies,
            "/sites":                                     state.managed_devices,
        }
